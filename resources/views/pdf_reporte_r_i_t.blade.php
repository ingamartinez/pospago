      ...
      <div id="details" class="clearfix">
        <div id="invoice">
          ...
          <div class="date">Fecha de consulta: {{ $date }}</div>
			...
			<div class="date">Total Ingresados: {{ @$contarreferido}}</div>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr>
			...
			<th class="unit">Fecha de Ingreso</th>
			<th class="unit">Fecha de {{ $data['actualizacion'] }}</th>
